...
1️⃣ اضغط *📖 قصة جديدة*
2️⃣ اختر الفئة واللغة والمدة
3️⃣ راجع القصة المقترحة
4️⃣ اضغط *📝 إنشاء السيناريو*
5️⃣ اضغط *🖼️ إنشاء الصور*
6️⃣ اضغط *🎙️ إنشاء الصوت*
7️⃣ اضغط *🎬 إنشاء الفيديو*

كل مرحلة منفصلة وتراها بشكل واضح ✅

*المفاتيح المطلوبة في Render:*
• \`GOOGLE_TTS_KEY\` — الصوت
• \`GROQ_API_KEY\` — السيناريو
• \`HUGGINGFACE_TOKEN\` — الصور`;
